...
const jobPostingJsonLd = {
  ...
  description:
    '<p>ドライヘッドスパ専門店「仙豆のちから 姫路大手前通り店」にて、お客様への施術とサロン業務全般をお任せします。水やオイルを一切使わない独自の技術で、お客様に極上の睡眠体験を提供するやりがいのあるお仕事です。</p><p>【具体的な業務】カウンセリング、ドライヘッドスパ施術、受付・接客、予約管理</p><p>【ここがポイント】未経験OK・研修充実・指名料100%還元・ノルマなし・手荒れの心配なし・シフト自由</p>',
  identifier: {
    '@type': 'PropertyValue',
